...
import { Search, User, Menu, Globe, CalendarDays, Users, Github } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center z-10">
            ...
            {/* GitHub Button */}
            <a 
              href="https://github.com/deepsuthar496/airbnb-clone" 
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center text-airbnb-dark hover:text-airbnb-primary transition-colors"
            >
              <Github size={20} />
            </a>
          </div>
